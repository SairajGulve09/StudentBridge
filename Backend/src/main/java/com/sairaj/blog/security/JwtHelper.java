...
//////	}
//////	
//////	public <T> T getClaimFromToken(String token,Function<Claims, T> clainsResolver)
//////	{
//////		final Claims claims = getAllClaimsFromToken(token);
//////		return clainsResolver.apply(claims);
//////	}
//////	
//////	//for retriving any information from token we will need the secreat
//////	
//////	private Claims getAllClaimsFromToken(String token)
//////	{
...
//////	{
//////		return Jwts.builder().setClaims(claims).setSubject(subject).setIssuedAt(new java.util.Date(System.currentTimeMillis()+JWT_TOKEN_VALIDITY * 1000)).setExpiration(new java.util.Date(System.currentTimeMillis()+JWT_TOKEN_VALIDITY * 1000)).signWith(SignatureAlgorithm.HS512, secretString).compact();
//////	}
//////	
//////	
//////	//validate token
